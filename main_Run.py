    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='visheshmdn70', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:/P2-Attendance-Management-System-using-Face-Recognition-main/P2-Attendance-Management-System-using-Face-Recognition-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:/2-Attendance-Management-System-using-Face-Recognition-main/P2-Attendance-Management-System-using-Face-Recognition-main/Attendance/Manually Attendance/')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'D:/P2-Attendance-Management-System-using-Face-Recognition-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:/P2-Attendance-Management-System-using-Face-Recognition-main/P2-Attendance-Management-System-using-Face-Recognition-main/Attendance')
    ...
    def log_in():
        ...
        if username == 'vishesh':
            if password == 'vishesh123':
                ...
                cs = 'D:/P2-Attendance-Management-System-using-Face-Recognition-main/P2-Attendance-Management-System-using-Face-Recognition-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
